...
if exist "C:\Program Files (x86)\Apsim74-r2286\Model\" (
  if exist sorghum.xml (
    ...
    if exist "C:\Program Files (x86)\Apsim74-r2286\Model\sorghum.xml" (
      copy "C:\Program Files (x86)\Apsim74-r2286\Model\sorghum.xml" sorghum.xml
      echo done!
      echo Run APSIM...
      "C:\Program Files (x86)\Apsim74-r2286\Model\ApsimRun" AgMip.apsim
      echo done!
  ...
  if exist sorghum.xml (
    ...
    echo Copy model file into working directory...
    if exist "C:\Program Files\Apsim74-r2286\Model\sorghum.xml" (
      copy "C:\Program Files\Apsim74-r2286\Model\sorghum.xml" sorghum.xml
      echo done!
      echo Run APSIM...
      "C:\Program Files\Apsim74-r2286\Model\ApsimRun" AgMip.apsim
      echo done!
