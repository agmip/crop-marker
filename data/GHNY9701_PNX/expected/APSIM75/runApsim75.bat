...
if exist "C:\Program Files (x86)\Apsim75-r3008\Model\" (
  if exist peanut.xml (
    ...
    if exist "C:\Program Files (x86)\Apsim75-r3008\Model\peanut.xml" (
      copy "C:\Program Files (x86)\Apsim75-r3008\Model\peanut.xml" peanut.xml
      echo done!
      echo Run APSIM...
      "C:\Program Files (x86)\Apsim75-r3008\Model\Apsim" AgMip.apsim
      echo done!
  ...
  if exist peanut.xml (
    ...
    echo Copy model file into working directory...
    if exist "C:\Program Files\Apsim75-r3008\Model\peanut.xml" (
      copy "C:\Program Files\Apsim75-r3008\Model\peanut.xml" peanut.xml
      echo done!
      echo Run APSIM...
      "C:\Program Files\Apsim75-r3008\Model\Apsim" AgMip.apsim
      echo done!
